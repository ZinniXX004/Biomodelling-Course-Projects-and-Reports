object Form2: TForm2
  Left = 0
  Top = 0
  Caption = '5023231017 - Jeremia Christ Immanuel Manalu - Knee Extension'
  ClientHeight = 1067
  ClientWidth = 1930
  Color = clBlack
  ...
  object ScrollBox1: TScrollBox
    ...
    object Chart1: TChart
      ...
      LeftAxis.Title.Caption = 'Length (m)'
    ...
    object Chart3: TChart
      ...
      BottomAxis.Title.Font.Color = clYellow
      LeftAxis.LabelsFormat.Font.Color = clYellow
      LeftAxis.Title.Caption = 'Muscle Torque'
      LeftAxis.Title.Font.Color = clYellow
      View3D = False
      Color = clTeal
      TabOrder = 4
    ...
    object GroupBox1: TGroupBox
      ...
      object ButtonShowEquation: TButton
        Left = 16
        Top = 151
        Width = 265
        Height = 58
        Caption = 'Show Equation'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clAqua
        Font.Height = -20
        Font.Name = 'Segoe UI'
        ...
        ParentFont = False
        TabOrder = 7
        OnClick = ButtonShowEquationClick
      end
      object ButtonShowDiagram: TButton
        Left = 312
        Top = 151
        Width = 281
        Height = 58
        ...
        ParentFont = False
        TabOrder = 8
        OnClick = ButtonShowDiagramClick
      end
    end
